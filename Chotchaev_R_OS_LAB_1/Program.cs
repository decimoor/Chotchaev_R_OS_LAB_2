...
namespace decimoor
{
  ...
  class Program
  {
    ...
    static public string letters = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
    static public Dictionary<int, string[]> dic = new Dictionary<int, string[]>
    {
      {1, new string[1]{letters} },
      {2, new string[2]{ "ABCDEFGHIJKLMNOPQRSTUVWXYZ", "abcdefghijklmnopqrstuvwxyz" } },
      {3, new string[4]{"ABCDEFGHIJKLM", "NOPQRSTUVWXYZ", "abcdefghijklm", "nopqrstuvwxyz"} },
      {4, new string[8]{ "ABCDEFG", "HIJKLMN", "OPQRSTU", "VWXYZab", "cdefghi", "jklmnop", "qrstu", "vwxyz" } }
    };
